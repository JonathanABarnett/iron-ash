...
export function ResourceCount({ resource, value, size = 14 }: { resource: Resource; value: number; size?: number }) {
  const s = RES_STYLE[resource];
  return (
    <div className={`inline-flex items-center gap-1 rounded-lg border px-2 py-0.5 ${s.bg} ${s.border}`}>
